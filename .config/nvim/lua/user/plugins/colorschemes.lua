...
return {
  ...
  colorscheme("sainnhe/everforest", { config = function() vim.g.everforest_better_performance = 1 end }),
  colorscheme("sainnhe/gruvbox-material", { config = function() vim.g.gruvbox_material_better_performance = 1 end }),
