...
local function spawn_with_shell(cmd)
  return function()
...
self.init = function()
  local globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "q", spawn_with_shell("~/.config/awesome/powermenu.sh"),
    ...
    -- Prompt
    awful.key({ modkey },            "r",     spawn_with_shell("dmenu_run -c -bw 5 -l 10 -nf '#567' -sb '#567' -sf '#222'"),
              {description = "run prompt", group = "launcher"}),
    awful.key({ modkey },            ";",     spawn_with_shell("~/.local/bin/launch.sh"),
              {description = "quick launch", group = "launcher"}),
