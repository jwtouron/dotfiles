...
return {
  keys = {
    ...
    { key = '?', mods = 'SHIFT|CTRL', action = act.SpawnCommandInNewTab { args = { os.getenv('SHELL'), '-c', '$WEZTERM_EXECUTABLE show-keys 2>&1 | less' } } },
    ...
    -- Lowercase duplicates of above--I don't think they're needed
    ...
    -- May never use these, but doesn't hurt to keep them...
