...
autocmd myaugroup FileType typescript,json setl formatexpr=CocAction('formatSelected')
# Update signature help on jump placeholder
autocmd myaugroup User CocJumpPlaceholder call CocActionAsync('showSignatureHelp')
